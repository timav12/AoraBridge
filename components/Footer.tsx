      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-0 text-xl tracking-tight mb-4">
              <span className="font-extrabold text-white">Aora</span>
              <span className="font-extrabold gradient-text">Bridge</span>
            </div>
            <p className="text-sm font-semibold tracking-widest text-[#64748B] mb-4">
